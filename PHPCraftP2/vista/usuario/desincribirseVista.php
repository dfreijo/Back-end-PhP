            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                            ...
                            if ($resultados && is_iterable($resultados)) {
                                foreach ($resultados as $acto) {
                                    ...
                                    if (in_array($Id_acto, $actosPersonaIds)) {
                                        ...
                                        echo "<button type='submit' name='inscribirse' class='btn btn-primary btn-inscripcion'>DesInscribirse</button>";
                                        echo "</form>";
                                        echo "</div>";
                                    }
                                }
                        ...
                        <button onclick="redirectToUsuarioVista('<?php echo urlencode($id); ?>', '<?php echo urlencode($username); ?>', '<?php echo urlencode($password); ?>', '<?php echo urlencode($email); ?>')" class="btn btn-block btn-primary align-self-end">Volver</button>   
                    </div>
                </div>
            </div>
        </div>
